...
public class Constant {
    ...
    public static final int MAIN_NAVIGATION_VIEW = R.id.navigation_view;
    public static final int MAIN_NAVIGATION_HEADER_LINEAR_LAYOUT = R.id.linear_layout_navigation_header;
    ...
    public static final int CATEGORY_FRAGMENT_LIST = R.id.list_view_category;
